    ...
    */
	$(document).ready(function() {
        if ($('table.calendar').getLength !== 0) {
            ...
            $('td.has-an-event').each(function(){
                calendarCell = $(this);
                calendarCellLinks = $(this).children('p').first().children('a');
                if (calendarCellLinks.length == 1) {
                    calendarCellLinkHref = calendarCellLinks.first().attr('href');
...
(function ($) {
    $(document).ready(function () {
        var $masonryTrgt = $("ul.cascaded-layout");
        $masonryTrgt.each(function () {
